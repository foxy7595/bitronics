    ...
    <div {...props} className={`${props.className} flex flex-col items-center flex-1 container-xs`}>
      <div className="relative h-[978px] self-stretch">
        ...
        {show && <Heading
          ...
          binary={true}
          delay={200}
          className="absolute bottom-0 !z-50 right-px m-auto w-[55%] !font-trirong text-[48px] font-semibold  leading-[70px] tracking-[1.44px] text-light_blue-a200 sm:w-[42%] sm:text-[40px]"
        >
          {descriptionText}
        </Heading>}
      </div>
