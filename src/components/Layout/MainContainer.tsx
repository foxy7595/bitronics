  ...
  return (
    <main>
      ...
      <div className="relative h-24 mt-20  overflow-hidden">
        ...
        >
          Empower Your <i className=" font-trirong">Growth</i> with{" "}
          <i className="font-trirong"> Advanced</i> System Development. Empower
          Your <i className=" font-trirong">Growth</i> with{" "}
          <i className="font-trirong"> Advanced</i> System Development. Empower
          Your <i className=" font-trirong">Growth</i> with{" "}
          <i className="font-trirong"> Advanced</i> System Development. Empower
          Your <i className=" font-trirong">Growth</i> with{" "}
          ...
          <i className="font-trirong"> Advanced</i> System Development. Empower
          Your <i className=" font-trirong">Growth</i> with{" "}
          <i className="font-trirong"> Advanced</i> System Development.
        </Heading>
      </div>
      <Contact />
