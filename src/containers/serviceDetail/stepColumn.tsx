...
export default function StepColumn({
    ...
    return (
        <div {...props} className={`${props.className} flex justify-start items-center sm:items-start gap-5 sm:gap-2 flex-1`}>
            <div className="flex h-[116px]   flex-col items-center  bg-[url(/images/img_group_16.svg)] bg-contain bg-no-repeat px-6 pb-4 pt-4 ">
                <Heading
                    size="headings"
                    as="h6"
